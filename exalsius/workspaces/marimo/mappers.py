...
from exalsius.workspaces.marimo.domain import DeployMarimoWorkspaceParams


@to_create_request.register(DeployMarimoWorkspaceParams)
def _(params: DeployMarimoWorkspaceParams) -> WorkspaceCreateRequest:
    ...
    variables: Dict[str, Any] = {
        ...
        "tokenPassword": params.marimo_password,
    }

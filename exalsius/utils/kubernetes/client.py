...
class KubeClientProtocol(Protocol):
    """Protocol for Kubernetes client features needed by mixins."""

    custom_objects_api: client.CustomObjectsApi

    def _make_api_call(self, api_func: Any, *args: Any, **kwargs: Any) -> Any: ...
...
class KubernetesClient:
    ...
    def get_api_resources(self, group: str, version: str) -> Any:
        """

...
* **auth:** add --organization option to device code login flow ([0b55552](https://github.com/exalsius/exalsius-cli/commit/0b555521deb8108f66eec33f9cf5d82d974c9936))
* **auth:** add PKCE login flow with browser callback and auto-detection ([1dace0e](https://github.com/exalsius/exalsius-cli/commit/1dace0eb9dceab04e6ab9c3c70f2a69cf6cac70f))
* **auth:** show organization, roles, and groups after login ([3c0a190](https://github.com/exalsius/exalsius-cli/commit/3c0a190531086c964dafdabcb9bfd857a4a3d855))
* **cli:** add confirmation prompts to destructive operations ([b458933](https://github.com/exalsius/exalsius-cli/commit/b458933a4bb52c2f390d5c781fd22281d8cac730))
* **cli:** show helpful messages when list commands return empty results ([4762d1f](https://github.com/exalsius/exalsius-cli/commit/4762d1f465ffc4c048cbca11a5765ae7ba5ba59d))
...
* **clusters:** add interactive mode to remove-nodes command ([77019fc](https://github.com/exalsius/exalsius-cli/commit/77019fcfd804f2bcdc4221ab88edf7185685fb58))
* **clusters:** add real-time cluster log streaming ([#182](https://github.com/exalsius/exalsius-cli/issues/182)) ([21570b6](https://github.com/exalsius/exalsius-cli/commit/21570b60749dc3ab4022faaf7f84fa28ac6ec775))
...
* **clusters:** implement add-nodes subcommand with interactive flow ([0801f31](https://github.com/exalsius/exalsius-cli/commit/0801f31a7c8367941bcb2c6d4e4a919ad221e8d5))
...
* **gateway:** map owner metadata from SDK to domain models ([18c2b84](https://github.com/exalsius/exalsius-cli/commit/18c2b84df8d0de2ee11180b43c1c33a1da703817))
...
* **management:** add SSH key scope support for org-wide and private keys ([72cf3be](https://github.com/exalsius/exalsius-cli/commit/72cf3be6890c702e8e65d3811d282642fb756766))
* **models:** add owner metadata fields to Cluster and Workspace models ([f52b8ea](https://github.com/exalsius/exalsius-cli/commit/f52b8ea43b2acc91aa01239f31a69876ee3e55ed))
...
* **nodes:** surface SSH key scope in node import flow ([fac2bb6](https://github.com/exalsius/exalsius-cli/commit/fac2bb69f802bb79bac9f41e642d38608696a997))
...
* **ui:** add color-coded status badges to table views ([e7d678f](https://github.com/exalsius/exalsius-cli/commit/e7d678f25f7e060520cf7cca0e16ac83225e141c))
* **ui:** display owner metadata in cluster and workspace listings ([f15ed77](https://github.com/exalsius/exalsius-cli/commit/f15ed771fad5c166d4c202448430fbef88dd2416))
* **ui:** use rounded table borders and brand-colored headers ([5355c45](https://github.com/exalsius/exalsius-cli/commit/5355c4534c2fb4f01921ad5e7c373d95625774cc))
* **ui:** use rounded table borders and brand-colored headers ([aecb7de](https://github.com/exalsius/exalsius-cli/commit/aecb7de2f9b76b87608723cc805b68c07caf33b1))
...
* **workspaces:** add access-description as suffix ([#185](https://github.com/exalsius/exalsius-cli/issues/185)) ([7c76da7](https://github.com/exalsius/exalsius-cli/commit/7c76da71cee9d90c655fee2ac922db145bd1591f))
* **workspaces:** add opinionated llm-inference workspace ([#176](https://github.com/exalsius/exalsius-cli/issues/176)) ([0f9428b](https://github.com/exalsius/exalsius-cli/commit/0f9428bc3bad663621959df42f803ded4beb8bae))
...
* **auth:** use 127.0.0.1 instead of localhost for callback url ([6b748f4](https://github.com/exalsius/exalsius-cli/commit/6b748f40d4cfcc875c1108e1e4b96f012a466605))
* **cli:** source --version from package metadata instead of hardcoded string ([88b0887](https://github.com/exalsius/exalsius-cli/commit/88b0887e363d291be4abdafa0c1715bdd2967dfe))
* **cli:** use typer.BadParameter for input validation errors ([eedb58b](https://github.com/exalsius/exalsius-cli/commit/eedb58beb3fc8dafbce5104bac54166667db3dac))
...
* **clusters:** assign WORKER role to nodes in scale_up_cluster ([f04d0f5](https://github.com/exalsius/exalsius-cli/commit/f04d0f57e97cefbb17cf45e6d76e6aef1a7e0cf3))
* **clusters:** enter interactive mode when no flags are provided, not vice versa ([4466b09](https://github.com/exalsius/exalsius-cli/commit/4466b09ee0840890ac2f748847232737d0839f14))
...
* **gateway:** migrate dashboard URL endpoint to ManagementApi for SDK v1.43.0 ([24c444b](https://github.com/exalsius/exalsius-cli/commit/24c444b5979cc0daf5505eecc2fdf95efb30282a))
...
* **models:** use default=None syntax for optional owner fields in Cluster model ([0fec7f9](https://github.com/exalsius/exalsius-cli/commit/0fec7f9a6a2254b142e61c22bf866108ffd440dd))
* move get-dashboard-url to management domain ([c905470](https://github.com/exalsius/exalsius-cli/commit/c905470fbbb8adf5a1442dff667b49aaf1d0b9dd))
...
* **nodes:** accept hostnames in addition to IPv4 addresses for node endpoint ([161d632](https://github.com/exalsius/exalsius-cli/commit/161d6324b4ff1a412072530c2ae515291c912631))
...
* **nodes:** improve list and detail view U ([#197](https://github.com/exalsius/exalsius-cli/issues/197)) ([bcfc3d1](https://github.com/exalsius/exalsius-cli/commit/bcfc3d14a2dc6f5cfc0b4b313c4fc24a5d151de1))
* pkce webbrower opening ([4318218](https://github.com/exalsius/exalsius-cli/commit/4318218323ecb997c399f26aca59d47d6821bb0f))
...
* run webrower.open in thread ([0e00a79](https://github.com/exalsius/exalsius-cli/commit/0e00a793553e16fe906bd4e934b157fb01c7d10d))
...
* support and display clusters DELETING status ([9057416](https://github.com/exalsius/exalsius-cli/commit/90574169e8a86e36dc7102f5b2b1c1b6a7ce2a9c))
* **tests:** add owner metadata parameters to test fixtures ([ffc1467](https://github.com/exalsius/exalsius-cli/commit/ffc1467c61777a29992dc8f01e50c315e2fbbff6))
...
* **clusters:** avoid eager node loading in list operations ([#184](https://github.com/exalsius/exalsius-cli/issues/184)) ([fd666b3](https://github.com/exalsius/exalsius-cli/commit/fd666b3087e16b2b85c69b76014f3ca13d7e29bd))


### Dependencies

* update exalsius-api-client SDK with owner metadata support ([02948cf](https://github.com/exalsius/exalsius-cli/commit/02948cfc26a9c8cb6da976d67fe2444e7cf77e19))

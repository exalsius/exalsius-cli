...
class TestAuth0ValidateTokenCommand:
    ...
    def test_execute_token_validation_error(
        self, mock_signature_verifier, mock_token_verifier
    ):
        request_dto = Auth0ValidateTokenRequestDTO(
            domain="test.domain",
            client_id="test_client_id",
    ...
    def test_execute_generic_error(self, mock_signature_verifier, mock_token_verifier):
        request_dto = Auth0ValidateTokenRequestDTO(
            domain="test.domain",
            client_id="test_client_id",
            id_token="test_id_token",
...
class TestStoreTokenOnKeyringCommand:
    ...
    def test_execute_success_without_refresh_token(self, mock_keyring):
        request = StoreTokenOnKeyringRequestDTO(
            client_id="test_client_id",
            access_token="test_token",
            expires_in=3600,
...
class TestLoadTokenFromKeyringCommand:
    ...
    def test_token_found_but_expiry_not(self, mock_keyring):
    ...
    def test_execute_keyring_exception(self, mock_keyring):
...
class TestAuth0RevokeTokenCommand:
    ...
    def test_execute_generic_error(self, mock_post):
        request = Auth0RevokeTokenRequestDTO(
            domain="test.domain",
            client_id="test_client_id",
            token="test_token_to_revoke",
